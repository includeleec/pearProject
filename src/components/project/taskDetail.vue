          ...
          <span v-if="task.parentTask">
            ...
            <a-breadcrumb separator=">" class="breadcrumb text-default">
              <a-breadcrumb-item
                ...
                :key="parent.code"
              >
                <a class="text-default" @click="init(parent.code)">{{
                  parent.name
                }}</a>
              </a-breadcrumb-item>
            </a-breadcrumb>
                    ...
                    <div class="field">
                      ...
                      <div class="field-right width-block">
                        ...
                        <div class="m-t-sm" v-if="hasMoreDesc">
                          <a
                            v-show="!showMoreDesc"
                            @click="checkShowMoreDesc(true)"
                            >显示更多</a
                          >
                          <a
                            v-show="showMoreDesc"
                            @click="checkShowMoreDesc(false)"
                            >收起备注</a
                          >
                        </div>
...
export default {
  ...
  methods: {
    ...
    taskTagChange(tag) {
      const index = this.task.tags.findIndex(
        (item) => item.tag_code == tag.code
      );
      if (index !== -1) {
