...
export function searchInviteMember(keyword, code) {
  return $http.post("project/project_member/searchInviteMember", {
    keyword: keyword,
    projectCode: code,
  });
}
export function inviteMember(memberCode, code) {
  return $http.post("project/project_member/inviteMember", {
    memberCode: memberCode,
    projectCode: code,
  });
}
export function _joinByInviteLink(inviteCode) {
  return $http.post("project/project_member/_joinByInviteLink", {
    inviteCode: inviteCode,
  });
}
export function removeMember(memberCode, code) {
  return $http.post("project/project_member/removeMember", {
    memberCode: memberCode,
    projectCode: code,
  });
}
...
export function listForInvite(data) {
  return $http.post("project/project_member/listForInvite", data);
}
